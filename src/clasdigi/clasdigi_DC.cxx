...
int main( int argc, char **argv )
{
   ...
   for(int ievent = 0; ievent<Nevents; ievent++) {
      ...
      process_DC_sigs(event->fDCEvent, sigs_event->fDCEvent);
      ...
      clas12::sigs::DCSigsEvent& sigs_event   )
{
   ...
   int npairs = hits_event.fNIonPairs;

   std::map<int, std::vector<DriftChamberIonPairHit*>>  fWireHits;

   for(int i = 0; i< npairs; i++) {

      DriftChamberIonPairHit  * ahit = (DriftChamberIonPairHit*)(*(hits_event.fIonPairs))[i];
